...
PLAY_SAMPLE:
  ...
  inc hl
  ; We divide it by 2. 
  ; This is a bit of a hack because it is a triplet count, not a sxxtuplet count, and we loop every 6 outputs.
  ; We could check in-loop but that would cost a bunch of samples; this way saves that time at the cost of maybe missing the last sample,
