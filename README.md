...
* Support for skewing the sample to improve the potential resolution, as the output are non-linear. This is based on work by blargg in [wav_to_psg](https://github.com/maxim-zhao/wav_to_psg).
